...
public:
    ...
    auto exportGraphToDot(std::string filename) -> void;
...
private:
    ...
    auto exportUndirectedGraphToDot(std::string filename) -> void;
    auto exportDirectedGraphToDot(std::string filename) -> void;
